...
from routers import accounts_pg as accounts
...
# Import PostgreSQL database components
from database_pg import create_tables, seed_database
...
app = FastAPI(
    ...
    description="A secure ATM system for account management with PostgreSQL backend",
    version="1.0.0",
...
async def root():
    """Root endpoint"""
    return {"message": "ATM System with PostgreSQL is running!"}
...
if __name__ == "__main__":
    ...
    # Using 8000 port as default
    port = int(os.environ.get("PORT", 8000))
    
    print(f"Starting ATM System with PostgreSQL on port {port}")
